...
INSERT INTO `sponsor` VALUES (1,'Nike',2),(2,'',3),(3,'House of Heroes',4),(4,'Wells Fargo Bank',NULL);
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `runnerUpdate`(IN `thisFName` VARCHAR(25), IN `thisLName` VARCHAR(25), IN `thisPhone` VARCHAR(25), IN `thisGender` VARCHAR(25), IN `thisIDRunner` INT)
    COMMENT 'Update a runner''s information.'
BEGIN
...
-- Dump completed on 2020-12-08 22:20:23
