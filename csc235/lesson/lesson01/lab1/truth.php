...
<body>
    ...
    <p>
        ...
        Eagles are known for their excellent vision. 
        They can view things from afar and zoom in on details at the same time.
    </p>
    <p>
        Eagles have an angle of vision of about 300 degrees and can magnify any given image up to eight times.
        They can scan an area of 30,000 hectares from 4,500 feet up in the air. 
        From this height, they can also see a rabbit in the grass.
    </p>
    <p>
        As a programmer, you have to be able to do the same thing with your code.
        You have to be able to understand the whole picture of the program while at the samt time being able to zoom 
        in and focus on minute details.
    </p>
